...
const CERTS = [
  {
    ...
    image: `${import.meta.env.BASE_URL}oracle-foundation-associate.png`,
  ...
  },
  {
    ...
    org: "Oracle Cloud Infrastructure",
    accent: "hsl(14,100%,55%)",
    image: `${import.meta.env.BASE_URL}oracle-architect-associate.png`,
  ...
  },
  {
    ...
    image: `${import.meta.env.BASE_URL}aws-cloud-practitioner-quest.png`,
